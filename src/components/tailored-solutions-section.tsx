...
export function TailoredSolutionsSection() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="font-heading text-2xl font-semibold sm:text-3xl lg:text-4xl max-w-3xl mx-auto bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-foreground">
          Tailored Solutions for Every Business
        </h2>
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
          {isMobile
            ? "See how our design empowers businesses to thrive."
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
                  ...
                  <div className="flex-grow text-center sm:text-left">
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground">
                      {isMobile
                        ? clientTypes[activeIndex].description.mobile
